...
[LibraryClasses.common.DXE_RUNTIME_DRIVER]
  # Runtime debug message may crash an OS unless serial output to MMIO mapped UARTs is inhibited
...
[BuildOptions]
  GCC:*_*_*_CC_FLAGS          = -DRPI_4_ONLY
  GCC:*_*_*_ASLPP_FLAGS       = -DRPI_4_ONLY
  GCC:*_*_*_ASLCC_FLAGS       = -DRPI_4_ONLY
  GCC:*_*_*_VFRPP_FLAGS       = -DRPI_4_ONLY
...
[PcdsDynamicHii.common.DEFAULT]
  ...
  #
  gRaspberryPiTokenSpaceGuid.PcdPi4GBSupported|L"Pi4GBSupported"|gConfigDxeFormSetGuid|0x0|0
  gRaspberryPiTokenSpaceGuid.PcdPi4GBEnabled|L"Pi4GBEnabled"|gConfigDxeFormSetGuid|0x0|0
