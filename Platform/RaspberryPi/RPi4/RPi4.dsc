...
[BuildOptions]
  ...
  DEFINE EXTRA_PP_FLAGS =
!if $(PL011_ENABLE) == TRUE
  DEFINE EXTRA_PP_FLAGS = -DPL011_ENABLE
!endif
  GCC:*_*_*_CC_FLAGS = $(EXTRA_PP_FLAGS)
  GCC:*_*_*_ASLPP_FLAGS = $(EXTRA_PP_FLAGS)
  GCC:*_*_*_ASLCC_FLAGS = $(EXTRA_PP_FLAGS)
